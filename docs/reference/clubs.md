...
**Endpoint**
```
GET https://www.play-cricket.com/api/v3/clubs.json
```
...
```
GET https://www.play-cricket.com/api/v3/clubs.json?api_token=YOUR_TOKEN&county_id=37
```

**Clubs updated in a date range (for polling changes):**
```
GET https://www.play-cricket.com/api/v3/clubs.json?api_token=YOUR_TOKEN&from_entry_date=01/01/2024&end_entry_date=01/02/2024
```
