...
**Endpoint**
```
GET https://www.play-cricket.com/api/v3/sites/{site_id}/teams.json
```
...
```
GET https://www.play-cricket.com/api/v3/sites/3540/teams.json?api_token=YOUR_TOKEN
```

**Teams updated within a date range:**
```
GET https://www.play-cricket.com/api/v3/sites/3540/teams.json?api_token=YOUR_TOKEN&from_entry_date=01/01/2024&end_entry_date=01/04/2024
```
