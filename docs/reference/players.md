...
**Endpoint**
```
GET https://www.play-cricket.com/api/v3/sites/{site_id}/players
```
...
```
GET https://www.play-cricket.com/api/v3/sites/3540/players?api_token=YOUR_TOKEN
```

**All members with any active role:**
```
GET https://www.play-cricket.com/api/v3/sites/3540/players?api_token=YOUR_TOKEN&include_everyone=yes
```

**Include members with historic squad roles:**
```
GET https://www.play-cricket.com/api/v3/sites/3540/players?api_token=YOUR_TOKEN&include_historic=yes
```
